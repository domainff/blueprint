...
function Gear() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="57" height="57" viewBox="0 0 57 57" fill="none" style={{height: '24px', width: 'auto', flexShrink: 0}}>
...
function Discord() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="72" height="52" viewBox="0 0 72 52" fill="none" style={{height: '20px', width: 'auto', flexShrink: 0}}>
