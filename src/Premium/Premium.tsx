...
export function WrappedPremium({blueprintId}: {blueprintId: string}) {
    ...
    const [threeFactorGrades, setThreeFactorGrades] = useState<ThreeFactorGrades>({
        qbInsulationScoreGrade: 0,
        rbInsulationScoreGrade: 0,
        wrInsulationScoreGrade: 0,
        teInsulationScoreGrade: 0,
        qbProductionScoreGrade: 0,
        rbProductionScoreGrade: 0,
        wrProductionScoreGrade: 0,
        teProductionScoreGrade: 0,
        qbSituationalScoreGrade: 0,
        rbSituationalScoreGrade: 0,
        wrSituationalScoreGrade: 0,
        teSituationalScoreGrade: 0,
    });
    ...
    return (
        <Premium
            ...
            valueProportion={{
                ...
                wr: blueprint?.premiumFeatures.valueProportionWr ?? 0,
                rb: blueprint?.premiumFeatures.valueProportionRb ?? 0,
                te: blueprint?.premiumFeatures.valueProportionTe ?? 0,
                pick: blueprint?.premiumFeatures.valueProportionDc ?? 0,
            }}
            startingQbAge={blueprint?.premiumFeatures.averageStarterAgeQb || 0}
            startingRbAge={blueprint?.premiumFeatures.averageStarterAgeRb || 0}
            startingWrAge={blueprint?.premiumFeatures.averageStarterAgeWr || 0}
            startingTeAge={blueprint?.premiumFeatures.averageStarterAgeTe || 0}
            rosterMakeup={makeup}
        />
    );
}
