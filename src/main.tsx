    ...
    <StrictMode>
        <HashRouter basename="/">
            <Routes>
                ...
                <Route
                    path="/bplookup"
                    element={<BlueprintDownloader appScript="https://script.google.com/macros/s/AKfycbxD-STCZPES3EnJART6pCYmJarpDlw5TeZjX_hL112jsISnDx-zZQJiSUKif-nLjViZlA/exec" />}
                />
                <Route
                    path="/algolookup"
