    ...
    <StrictMode>
        <HashRouter basename="/">
            <Routes>
                ...
                <Route
                    path="/bplookup"
                    element={<BlueprintDownloader appScript="https://script.google.com/macros/s/AKfycbya-JJqGDw9WTEDAt4B4tPRRsDeyZTkYR4v4HV_kXSLHojKCIZVXv8yLhWEhg1VVXkeWw/exec" />}
                />
                <Route
                    path="/algolookup"
