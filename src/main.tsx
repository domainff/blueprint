    ...
    <StrictMode>
        <HashRouter basename="/">
            <Routes>
                ...
                <Route
                    path="/bplookup"
                    element={<BlueprintDownloader appScript="https://script.google.com/macros/s/AKfycbzbqiJUGHDxI5u0PtDgyghmCV1jeDKnuWBMFWYv_8XeDthvvHDtzSuC94UDTVmaUNgNhg/exec" />}
                />
                <Route
                    path="/algolookup"
