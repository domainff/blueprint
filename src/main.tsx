    ...
    <StrictMode>
        <HashRouter basename="/">
            <Routes>
                ...
                <Route
                    path="/bplookup"
                    element={<BlueprintDownloader appScript="https://script.google.com/macros/s/AKfycby9m---DCNz05cM_nfGXCOIsl7Kk7dbTqU961rfT3cbivgmaOgHos2oqbYj0c-TNo6TVA/exec" />}
                />
                <Route
                    path="/algolookup"
                    element={<WeeklyAlgorithm appScript="https://script.google.com/macros/s/AKfycbwyN8Z-pm-Wi71fn3iuk5F-pJHYexy_Ko0RWocqx83QeZLlId42ewz4jd5t-pzKwldw/exec" />}
                />
            </Routes>
        </HashRouter>
    </StrictMode>
