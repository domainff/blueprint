    ...
    <StrictMode>
        <HashRouter basename="/">
            <Routes>
                ...
                <Route
                    path="/bplookup"
                    element={<BlueprintDownloader appScript="https://script.google.com/macros/s/AKfycbzKhmdAO3GodBGGB1iYd6GFAWmuJJDC9T9yM03-XOlMBe8qygPxGmHr5nif9HHsekO-CQ/exec" />}
                />
                <Route
                    path="/algolookup"
                    element={<WeeklyAlgorithm appScript="https://script.google.com/macros/s/AKfycbw14ilfmlkvPc3kcNrz0asC1Td9YJV8Q4LWz3iVVcgok0QmU5Tz2dn0PAUEBaoE1bfO8Q/exec" />}
                />
            </Routes>
        </HashRouter>
    </StrictMode>
