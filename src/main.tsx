    ...
    <StrictMode>
        <HashRouter basename="/">
            <Routes>
                ...
                <Route
                    path="/bplookup"
                    element={<BlueprintDownloader appScript="https://script.google.com/macros/s/AKfycbwClPEyW3I8WICr5l8YwihEQhYFF1BMJtjtT4HFq3Y6-9aWGRNJKdi36hPlqSOT2PhOjA/exec" />}
                />
                <Route
                    path="/algolookup"
